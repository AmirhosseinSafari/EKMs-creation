...
from user_ekm_functions import user_ekm_sbf_bpf_shifted_dataset
...
def processing_ecg_files(users_ecg_files_chunk):
    with multiprocessing.Manager() as manager:
        ...
        with multiprocessing.Pool(processes=num_processes) as pool:
            ...
            pool.starmap(user_ekm_sbf_bpf_shifted_dataset, [(user, shared_counter, lock, len(users_ecg_files_chunk), shifted_amount) for user in users_ecg_files_chunk])
