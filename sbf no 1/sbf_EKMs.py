...
from user_ekm_functions import user_ekm_no_1_dataset
...
with multiprocessing.Manager() as manager:
    ...
    with multiprocessing.Pool(processes=num_processes) as pool:
        ...
        pool.starmap(user_ekm_no_1_dataset, [(user, shared_counter, lock, len(users_ecg_files)) for user in users_ecg_files])
